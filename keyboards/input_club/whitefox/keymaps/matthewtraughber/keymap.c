...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    */
  [0] = LAYOUT_truefox( \
    QK_GESC,            KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,             KC_0,    KC_MINS,            KC_EQL,  KC_DEL,    KC_BSPC,    TD(LEDTOG_CAPS), \
    ...
    TD(LSFT_SPACECMDR), KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,           KC_SLSH, TD(RSFT_SPACECMDR), KC_UP,   _______, \
  ...
  [1] = LAYOUT_truefox( \
    ...
    _______, KC_MPRV, KC_MPLY, KC_MNXT, KC_PAUSE, _______, _______, KC_PGUP, KC_UP,   KC_PGDN, KC_PSCR, _______, _______, _______, _______,  \
